...
NDK_DEBUG_MODULES := $(APP_DEBUG_MODULES)
...
# If undefined, look in $(APP_PROJECT_PATH)/make.mk
#
...
ifdef APP_BUILD_SCRIPT
    ...
    _build_script := $(strip $(wildcard $(APP_PROJECT_PATH)/make.mk))
    ifndef _build_script
        $(call __ndk_info,There is no make.mk under $(APP_PROJECT_PATH))
