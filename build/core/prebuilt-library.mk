...
LOCAL_DEPS_MODULES := $(strip $(LOCAL_DEPS_MODULES))

# LOCAL_SRC_FILES should be clear, so forward depends it.
$(prebuilt_path): $(LOCAL_DEPS_MODULES)
ifndef LOCAL_DEPS_MODULES
ifndef prebuilt
...
#the prebuilt static library already defiend.
ifndef LOCAL_BUILT_MODULE
$(call handle-module-built)
LOCAL_BUILT_MODULE := $(addsuffix $(LOCAL_PREBUILT_SUFFIX),$(strip $(LOCAL_BUILT_MODULE)))
...
#if defined LOCAL_RELEATE_PATH, we are must be statment varable LOCAL_OBJECTS,
#it is by LOCAL_INSTALLED_RELEASE target used in the build-th3-binary-obj.mk 
ifdef LOCAL_INSTALLED_RELEASE
