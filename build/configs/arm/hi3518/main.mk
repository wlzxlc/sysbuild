...
ifneq ($(IPC_PLAT),ipcv7)
$(call include-makefile, $(TARGET_SDK_DIR)/make.mk)
$(call include-all-subs-makefile,$(PACKAGES_PATH)/802dot1x \
                             $(PACKAGES_PATH)/ddns \
                             $(PACKAGES_PATH)/drvlib \
                             $(PACKAGES_PATH)/ftpc \
                             $(PACKAGES_PATH)/linux_lsp \
                             $(PACKAGES_PATH)/netcbbs \
                             $(PACKAGES_PATH)/smoothsend \
                             $(PACKAGES_PATH)/udm \
                             $(PACKAGES_PATH)/upnp)
...
#$(call include-makefile, $(TARGET_WORKSPACE)/packages/make.mk)
#PACKAGES_PATH := $(call my-dir)
$(call include-all-subs-makefile,$(PACKAGES_PATH)/802dot1x \
                             $(PACKAGES_PATH)/mediactrl \
                             $(PACKAGES_PATH)/ddns \
                             $(PACKAGES_PATH)/drvlib \
                             $(PACKAGES_PATH)/ftpc \
                             $(PACKAGES_PATH)/kdbox \
...
lc2150bn_v5: $(TARGET_BOARD)
lc2150bn_v7: $(TARGET_BOARD)
